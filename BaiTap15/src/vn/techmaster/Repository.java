...
public class Repository {
    ...
    public  ArrayList<Documents> getDocument() {
        ...
        listDocument.add(new Documents(111, "A2", "AA2", 2019, LocalDate.of(2019, 11, 11), new String[]{"Luật Pháp"}, 5.5, 1000));
        listDocument.add(new Documents(222, "B2", "BB2", 2017, LocalDate.of(2017, 8, 11), new String[]{"Toán Logic",}, 6.6, 5555));
        listDocument.add(new Documents(333, "C2", "CC2", 2017, LocalDate.of(2017, 5, 1), new String[]{"Mẹ và Bé"}, 3.3, 3500));
        listDocument.add(new Documents(444, "D2", "DD2", 2018, LocalDate.of(2018, 10, 6), new String[]{"Doanh Nhân"}, 4.5, 3200));
        listDocument.add(new Documents(555, "E2", "EE2", 2018, LocalDate.of(2018, 12, 22), new String[]{"Kỹ Năng Sống"}, 7.2, 2500));
        listDocument.add(new Documents(666, "F2", "FF2", 2020, LocalDate.of(2020, 1, 31), new String[]{"Kinh tế", "Chính Trị"}, 3.5, 1001));
        return listDocument;
    }
}
